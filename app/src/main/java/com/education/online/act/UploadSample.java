...
public class UploadSample extends AppCompatActivity {
     ...
     */
    private static final String publicKey = "qUEgbZuyW/olikr4Yr9I4zY2zMC35z4m7C19XGMGakUzN8nZ8SkKrw==";
    private static final String privatekey = "0e6d3171bf1ccdb3d771832dee1ffabbdbcd16e9";

    /**
     * bucket : bucket name
     * proxySuffix : 域名后缀
     */
    private static final String bucket = "longforlearn";
    ...
    private File getTestFile() {
        ...
        return new File(sdcard, "test.png");
    }
    ...
    private File getSaveFile() {
        ...
        return new File(download, "test.png");
    }
