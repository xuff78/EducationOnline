...
import com.education.online.util.HmacSha;
import com.education.online.util.LogUtil;
import com.education.online.util.MapUtil;
...
public class LeanSignatureUtil {
    ...
    public static FormBody.Builder sign(Context context, String url_api, Map<String, String> params) {
        ...
        try {
            ...
            while(var14.hasNext()) {
                ...
                newFormBody.addEncoded((String)entry.getKey(), (String)entry.getValue());
            }
