...
public class SelectPicDialog extends Dialog implements View.OnClickListener {
    ...
    public SelectPicDialog(Activity act) {
...
//        dialog_layout.setLayoutParams(new RelativeLayout.LayoutParams(-1, -2));
    ...
    private void takePhoto() {
        ...
        if(SDState.equals(Environment.MEDIA_MOUNTED))
        {
            ...
            photoUri = act.getContentResolver().insert(MediaStore.Images.Media.EXTERNAL_CONTENT_URI, values);
            intent.putExtra(MediaStore.EXTRA_OUTPUT, photoUri);
            /**-----------------*/
            act.startActivityForResult(intent, SELECT_PIC_BY_TACK_PHOTO);
        }else{
    ...
    private void pickPhoto() {
        ...
        act.startActivityForResult(intent, SELECT_PIC_BY_PICK_PHOTO);
    }
