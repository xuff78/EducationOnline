...
public class MediaAdapter extends CursorAdapter implements RecyclerListener {
    ...
    private List<ImageView> pickerImageView =new ArrayList<>();
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        holder.isselected.setSelected(isSelected);
        if (isSelected) {
            mPickerImageViewSelected.add(holder.imageView);
            pickerImageView.add(holder.isselected);
        }
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        holder.isselected = (ImageView) root.findViewById(R.id.isselected);
    ...
    public void onMovedToScrapHeap(View view) {
        ...
        ImageView isselected = (ImageView) view.findViewById(R.id.isselected);
        pickerImageView.remove(isselected);
    }

    public void onDestroyView() {
        mPickerImageViewSelected.clear();
        pickerImageView.clear();
    }
}