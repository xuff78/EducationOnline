...
//    int notificationId = (new Random()).nextInt();
    ...
    String SoundEnable=SharedPreferencesUtil.getString(context, "SoundEnable");
//    String VibrateEnable=SharedPreferencesUtil.getString(context, "VibrateEnable");
    if(SoundEnable.equals("1")||SoundEnable.equals(SharedPreferencesUtil.FAILURE_STRING))
        notification.sound = Uri.parse(ContentResolver.SCHEME_ANDROID_RESOURCE + "://"
            + context.getApplicationContext().getPackageName() + "/raw/" + R.raw.ios7sms);
//    if(VibrateEnable.equals("1")||VibrateEnable.equals(SharedPreferencesUtil.FAILURE_STRING)) {
//        long[] vibrate = {0, 100, 200, 300};
//        notification.vibrate = vibrate;
//    }

    String PushEnable=SharedPreferencesUtil.getString(context, "PushEnable");
    if(PushEnable.equals("1")||PushEnable.equals(SharedPreferencesUtil.FAILURE_STRING))
      manager.notify(REPLY_NOTIFY_ID, notification);
  }

  public static void showNotificationForActivity(Context context, String title, String content, String sound, Intent intent) {
    intent.setFlags(0);
//    int notificationId = (new Random()).nextInt();
